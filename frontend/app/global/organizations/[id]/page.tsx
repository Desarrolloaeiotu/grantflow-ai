...
interface Analysis {
  capital: { text: string; conclusion: string }
  model_export: { text: string; conclusion: string }
  network: { text: string; conclusion: string }
  colombia: { text: string; conclusion: string }
  latam: { text: string; conclusion: string }
  primary_role: string
}

export default function GlobalOrganizationDetailPage() {
  ...
  return (
    <div className="page">
      ...
      <div style={{ marginBottom: '30px' }}>
        <Link href="/global/organizations" style={{ color: 'var(--primary)', textDecoration: 'none', fontSize: '12px', marginBottom: '16px', display: 'inline-block' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        <h3 style={{
          ...
          🔍 ANÁLISIS ESTRATÉGICO PARA AEOTU
        </h3>
          ...
          <>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '12px', color: 'var(--muted)', margin: '8px 0' }}>
                {analysis.capital.text}
              </p>
              <div style={{
                fontSize: '12px',
                fontWeight: 600,
                color: analysis.capital.conclusion === 'Alto' ? '#388E3C' : analysis.capital.conclusion === 'Medio' ? '#FF9800' : '#D32F2F'
              }}>
                Conclusión: {analysis.capital.conclusion}
              </div>
            </div>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '12px', color: 'var(--muted)', margin: '8px 0' }}>
                {analysis.model_export.text}
              </p>
              <div style={{
                fontSize: '12px',
                fontWeight: 600,
                color: analysis.model_export.conclusion === 'SÍ' ? '#388E3C' : '#D32F2F'
              }}>
                Conclusión: {analysis.model_export.conclusion}
              </div>
            </div>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '12px', color: 'var(--muted)', margin: '8px 0' }}>
                {analysis.network.text}
              </p>
              <div style={{
                fontSize: '12px',
                fontWeight: 600,
                color: analysis.network.conclusion.startsWith('SÍ') ? '#388E3C' : '#D32F2F'
              }}>
                Conclusión: {analysis.network.conclusion}
              </div>
            </div>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '12px', color: 'var(--muted)', margin: '8px 0' }}>
                {analysis.colombia.text}
              </p>
              <div style={{
                fontSize: '12px',
                fontWeight: 600,
                color: analysis.colombia.conclusion === 'Sí' ? '#388E3C' : '#D32F2F'
              }}>
                Conclusión: {analysis.colombia.conclusion}
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                fontSize: '12px',
                fontWeight: 600,
                color: analysis.latam.conclusion === 'Prioridad' ? '#388E3C' : analysis.latam.conclusion === 'Secundaria' ? '#FF9800' : '#D32F2F'
              }}>
                Conclusión: {analysis.latam.conclusion}
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '12px', color: 'var(--muted)', marginBottom: '8px', textTransform: 'uppercase' }}>
                Rol Dominante
              </div>
              <div style={{
                fontSize: '16px',
                ...
                🎯 {analysis.primary_role === 'exportacion' ? 'Exportación del Modelo' : analysis.primary_role === 'capital' ? 'Capital' : 'Posicionamiento'}
              </div>
            </div>
          </>
        )}
