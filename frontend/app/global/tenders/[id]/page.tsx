...
export default function GlobalTenderDetailPage() {
  ...
  return (
    <div className="page">
      <Link href="/global/tenders" style={{ color: 'var(--primary)', textDecoration: 'none', fontSize: '12px', marginBottom: '16px', display: 'inline-block' }}>
